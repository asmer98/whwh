...
an2 = datetime.datetime(2025, 2, 9, 12, 00, 00)#تحكم بالوقت
if an > an2 or an == an2:
        exit("انتهى تفعيل اشتراكك راسل المطور احمد خان للاشتراك يوزر للتواصل AHMED_KHANA")
else:
        pass
import requests
...
iid="971838022"
tok="8190737892:AAE5lYzEPUOrngtn9JeT88B1xITHov0ZQz8"
os.system('clear')
def rest(email):
    email=email.split('@')[0]
