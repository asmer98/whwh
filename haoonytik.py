...
an2 = datetime.datetime(2025, 2, 26, 3, 00, 00)#تحكم بالوقت
if an > an2 or an == an2:
        exit("انتهت مدة تفعيل اشتراكك لتفعيل الاداة مره اخرى يرجى مراسله المطور للاشتراك")
else:
        pass
import requests
...
iid='5824922611'
tok='7620424156:AAFrG6lztlchCw6YMKBzFpDVAJxVQbJJ6MA'
os.system('clear')
